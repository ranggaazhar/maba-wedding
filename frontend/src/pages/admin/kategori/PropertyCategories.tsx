    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
              ...
              <div key={category.id} className="border rounded-lg p-4 bg-card space-y-3 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <span className="text-2xl flex-shrink-0">{propertyCategoryIcons[category.slug] || '📦'}</span>
          ...
          <div className="hidden md:block border rounded-lg bg-card overflow-hidden shadow-sm">
